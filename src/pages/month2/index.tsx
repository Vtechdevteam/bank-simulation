...
const Page1 = () => {
    ...
    const getSettingsData = async (savings:any,creditCardDue:any,loanDue:any) => {
        ...
        try {
            ...
            setData(masterData)
            const month1: FinanceDaum = masterData?.financeData?.filter(e => e.sequenceNumber === 2)[0]
            const initValue = {...initialValues}
            initValue['initialPayout'] = +month1?.initialPayout
            initValue['creditCardDue'] = +creditCardDue
            initValue['loanDue'] = +loanDue
                                ...
                                <div className="w-1/2">
                                    ...
                                    <div className="my-4 w-4/5">
                                        ...
                                        <div className="mx-4 mt-3 font-semibold grid grid-cols-5 ">
                                            ...
                                            <label className="col-span-1">{getTotalDeptBalance(formik?.values?.creditCardDue,formik?.values?.loanDue).toFixed(2)}</label>
                                        </div>
